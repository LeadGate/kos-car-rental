  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="A hire car reaches the Asklepion, Zia, Antimachia Castle and Paleo Pyli on paved roads, but Kalymnos, Nisyros and Bodrum require leaving the car at the port."
