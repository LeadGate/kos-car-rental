...
const AirportPage = () => {
  ...
  return (
    <Layout>
      <SEOHead title="Kos Airport Car Rental: KGS Pickup in 20–30 Minutes"
        description="Kos International Airport (KGS / Ippokratis), operated by Fraport Greece, has one arrivals flow and most renters reach their car in 20–30 minutes after landing."
