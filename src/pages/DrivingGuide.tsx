  ...
  return (
    <Layout>
      ...
      >
          ...
          <DataTable headers={["Violation", "Fine (EUR)", "Additional Penalty"]} rows={[["Speeding up to 20 km/h over the limit", "\u20ac150", "-"], ["Speeding 20-30 km/h over the limit", "\u20ac150", "20-day licence withdrawal"], ["Speeding 30-50 km/h over the limit", "\u20ac350", "30-day licence & registration withdrawal"], ["Speeding more than 50 km/h over the limit", "\u20ac700", "60-day on-the-spot licence withdrawal"], ["Driving without a seatbelt", "\u20ac350", "30-day licence & registration withdrawal"], ["Using a mobile phone without hands-free kit", "\u20ac350", "30-day licence & registration withdrawal"], ["Parking on a yellow line", "\u20ac30", "10-day licence withdrawal"], ["Running a red light", "\u20ac700", "60-day on-the-spot licence withdrawal"], ["Drunk driving, BAC-dependent (3 tiers)", "\u20ac350-\u20ac1,200", "30-180 day licence & registration withdrawal; imprisonment above 1.10 g/l"]]} />
      ...
      >
          ...
          <DataTable headers={["Zone", "Rule", "Typical Cost / Penalty"]} rows={[["Blue lines", "Paid parking", "\u20ac1-\u20ac2 per hour"], ["White lines", "Free parking", "Usually limited and quickly occupied"], ["Yellow lines", "No parking", "\u20ac30 fine + 10-day licence withdrawal"], ["Port fenced area", "No unauthorised parking", "Fine or towing"]]} />
